...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.passengersOrganizerOne': '{passengers} passengers + 1 organizer',
  'dashboard.hero.passengersOrganizersMany': '{passengers} passengers + {organizers} organizers',
