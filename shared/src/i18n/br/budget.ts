...
const budget: TranslationStrings = {
  ...
  'costs.assignmentPendingTitle': 'Aguardando definição',
  'costs.assignmentPendingBody': 'Defina quem pagará e como o valor será dividido antes de registrar pagamentos.',
  'costs.pay': 'paga',
  'costs.pays': 'paga',
