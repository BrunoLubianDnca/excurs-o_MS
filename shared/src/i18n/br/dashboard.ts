...
const dashboard: TranslationStrings = {
  ...
  'dashboard.passengers': 'Passageiros',
  ...
  'dashboard.hero.passengersOrganizerOne': '{passengers} passageiros + 1 organizador',
  'dashboard.hero.passengersOrganizersMany': '{passengers} passageiros + {organizers} organizadores',
